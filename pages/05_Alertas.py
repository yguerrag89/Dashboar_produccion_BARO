...
include_otros = st.sidebar.toggle("Incluir OTROS", value=False)
...
sku_f = sku_f.sort_values(["pct_segunda", "piezas_total_ps"], ascending=[False, False]).head(int(top_n)).reset_index(drop=True)
